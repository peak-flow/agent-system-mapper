...
curl -fsSL "${BASE_URL}/prompts/02a-recommend-code-flows.md" -o "${TARGET_DIR}/prompts/02a-recommend-code-flows.md"
curl -fsSL "${BASE_URL}/prompts/03-data-models.md" -o "${TARGET_DIR}/prompts/03-data-models.md"
curl -fsSL "${BASE_URL}/prompts/04-diagrams.md" -o "${TARGET_DIR}/prompts/04-diagrams.md"
curl -fsSL "${BASE_URL}/prompts/05-test-surface.md" -o "${TARGET_DIR}/prompts/05-test-surface.md"

# Download LSP-optimized prompts
echo "Downloading LSP-optimized prompts..."
curl -fsSL "${BASE_URL}/prompts/lsp/01-architecture-overview.md" -o "${TARGET_DIR}/prompts/lsp/01-architecture-overview.md"
curl -fsSL "${BASE_URL}/prompts/lsp/02-code-flows.md" -o "${TARGET_DIR}/prompts/lsp/02-code-flows.md"
curl -fsSL "${BASE_URL}/prompts/lsp/02a-recommend-code-flows.md" -o "${TARGET_DIR}/prompts/lsp/02a-recommend-code-flows.md"
curl -fsSL "${BASE_URL}/prompts/lsp/README.md" -o "${TARGET_DIR}/prompts/lsp/README.md"
...
curl -fsSL "${BASE_URL}/examples/livewire/bad-architecture-doc-example.md" -o "${TARGET_DIR}/examples/livewire/bad-architecture-doc-example.md"

# React
curl -fsSL "${BASE_URL}/examples/react/good-architecture-doc-example.md" -o "${TARGET_DIR}/examples/react/good-architecture-doc-example.md"
curl -fsSL "${BASE_URL}/examples/react/bad-architecture-doc-example.md" -o "${TARGET_DIR}/examples/react/bad-architecture-doc-example.md"
...
curl -fsSL "${BASE_URL}/examples/packages/requests/good-architecture-doc-example.md" -o "${TARGET_DIR}/examples/packages/requests/good-architecture-doc-example.md"
curl -fsSL "${BASE_URL}/examples/packages/requests/bad-architecture-doc-example.md" -o "${TARGET_DIR}/examples/packages/requests/bad-architecture-doc-example.md"

# Test surface examples (framework-agnostic)
echo "Downloading test surface examples..."
curl -fsSL "${BASE_URL}/examples/test-surface/good-test-surface-example.md" -o "${TARGET_DIR}/examples/test-surface/good-test-surface-example.md"
curl -fsSL "${BASE_URL}/examples/test-surface/bad-test-surface-example.md" -o "${TARGET_DIR}/examples/test-surface/bad-test-surface-example.md"
...
curl -fsSL "${BASE_URL}/verify.py" -o "${TARGET_DIR}/verify.py"

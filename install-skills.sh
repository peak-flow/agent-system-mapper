...
curl -fSL "${BASE_URL}/skills/map-verify.md" -o "${TARGET_DIR}/map-verify.md"
...
curl -fSL "${BASE_URL}/skills/map-recommend-lsp.md" -o "${TARGET_DIR}/map-recommend-lsp.md"
...
echo "  /map-recommend-lsp - Recommend flows (LSP-verified)"
echo "  /map-tests        - Derive test candidates"
echo "  /map-verify       - Verify citations + quoted code in a doc"
echo ""
